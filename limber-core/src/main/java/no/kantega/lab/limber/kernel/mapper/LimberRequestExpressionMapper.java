...
public class LimberRequestExpressionMapper implements IRequestMapper {
    ...
    public LimberRequestExpressionMapper() {
    ...
    public IRequestMapping map(@Nonnull IHttpServletRequestWrapper httpServletRequestWrapper) {
        ...
        // Check if this expression mapper can be applied at all.
